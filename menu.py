...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('HOHOHO GIVE MY SLEIGH BACK', 25, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 20)
...
class OptionsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            self.game.check_events()
            self.check_input()
            self.game.display.fill((104, 159, 90))
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('diew ma sia credits', 20, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 10)
            self.blit_screen()